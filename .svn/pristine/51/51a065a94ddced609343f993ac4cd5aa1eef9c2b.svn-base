      ...
      fetchData () {
        ...
        this.$http.get(url)
          .then((res) => {
            ...
            this.pagetotal = this.data_list[0].totalcount;
          });
...
<style>
  ...
  .MultiLineString
  {
    background-image: url(../../assets/img/esriGeometryPolyline.png);
  }
  .Point,
  .MultiPoint
  {
    background-image: url(../../assets/img/esriGeometryPoint.png);
  }
  .Polygon,
  .MultiPolygon
  {
    background-image: url(../../assets/img/esriGeometryPolygon.png);
  }
  .esriGeometryPolygon{
    background-image: url(../../assets/img/esriGeometryPolygon.png);
  }
