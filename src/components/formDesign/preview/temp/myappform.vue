          ...
          >
            ...
            <label v-if="item.tagname === 'img'" class="widget img">
              <span
                :is="item.tagname"
                :style="item.style"
                :src="item.src ? item.src : ''" :alt = "item.description"
                class="img_content" style="width: 100%;height: 100%;box-sizing: border-box;"
              >
              </span>
            </label>
...
<style lang="less" scoped>
  p,h1,h2,h3,h4,h5,h6,img,label,input,textarea,ul,li,ol,select,option{
    margin: 0;
    padding: 0;
